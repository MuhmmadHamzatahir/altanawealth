function drawCharts(){
    ...
    loadVisualization('adas_monthly_perf_ALTDASA.csv', drawPerfTable, 'adas-fund-table02');
    loadVisualization('adas_monthly_perf_ALTDASA.csv', drawPerfTable, 'adas-fund-table03');
    loadVisualization('adas_monthly_perf_ALTDASA.csv', drawPerfTable, 'adas-fund-table04');
    ...
    loadVisualization('adas_monthly_perf_ALTDASA.csv', drawPerfTable, 'adas-fund-table05');
