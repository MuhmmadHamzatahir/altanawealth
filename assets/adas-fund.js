function drawCharts(){
    ...
    loadVisualization('adas_monthly_perf_ALTDASA.csv', drawPerfTable, 'adas-fund-table01', false, 2);
    loadVisualization('adas_monthly_perf_GS.csv', drawPerfTable, 'adas-fund-table02', false, 2);
    loadVisualization('adas_monthly_perf_HFRX.csv', drawPerfTable, 'adas-fund-table03', false, 2);
    loadVisualization('adas_monthly_perf_split_returns.csv', drawPerfTable, 'adas-fund-table04', false, 2);
    ...
    loadVisualization('adas_monthly_perf_gross_net.csv', drawPerfTable, 'adas-fund-table05', false, 0);
